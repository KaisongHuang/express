...
public class CourierData extends UnicastRemoteObject implements CourierDataBaseService{
	...
	public ResultMessage insert(Object po) throws RemoteException{
		...
		if(po instanceof CourierPO){
			...
			sql="insert into Sender values('"+po1.getSenderName()+"',"+"'"+po1.getSenderAddress()+"',"+"'"+po1.getSenderCompany()+"',"+"'"+po1.getSenderCall()+"',"+"'"+po1.getSenderPhone()+"',"+"'"+po1.getRecipientName()+"',"+"'"+po1.getRecipientAddress()+"',"+"'"+po1.getRecipientCompany()+"',"+"'"+po1.getRecipientCall()+"',"+"'"+po1.getRecipientPhone()+","+po1.getPcs()+","+po1.getWeight()+","+po1.getVolume()+",'"+po1.getCommodity()+"','"+po1.getSize()+"','"+po1.getBagging()+"',"+po1.getTotal()+",'"+barcode+"','"+po1.getType()+");";
			rm=db.insert(sql);
			return rm;
		}
