...
public class MockWarehouseTest {
	...
	public void test() {
		ResultMessage warehouse1 = new MockWarehouse()
				.importGoods(new InStorageVO(null, null, null,null, null, 0, 0, 0, 0));
		ResultMessage warehouse2 = new MockWarehouse().exportGoods(new OutStorageVO(null, null, null,null, null, null, 0));
		...
		ResultMessage warehouse9 = new MockWarehouse()
				.initWarehouse(new InStorageVO(null, null, null,null, null, 0, 0, 0, 0));
