...
public class WarehouseMenuUI extends JPanel {
	...
	public void init() {
		...
		button1 = new MyButton("出库入库","/导航/出库入库.png");// "出库入库"
