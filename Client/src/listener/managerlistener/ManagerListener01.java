...
import presentation.managerui.ManagerUI01;
import vo.EmployeeVO;

public class ManagerListener01 implements MouseListener, ActionListener {
	
	private ManagerUI01 ui;
	ManagerBlService manager = new Manager();
	CardLayout card;
	public ManagerListener01 (ManagerUI01 ui, CardLayout card){
		super();
		this.ui=ui;
		this.card=card;
	}
