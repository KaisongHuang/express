...
import presentation.sellingareaui.SellingAreaUI31;
import vo.CarVO;

public class SellingAreaListener31 implements ActionListener {

	private SellingAreaUI31 ui;
	SellingareaBlService sellingarea = new SellingArea();
<<<<<<< HEAD
	CardLayout card;
	public SellingAreaListener31 (SellingAreaUI31 ui, CardLayout card){
		super();
		this.ui=ui;
		this.card=card;
=======
