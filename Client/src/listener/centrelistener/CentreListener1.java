...
public class CentreListener1 implements MouseListener, ActionListener {
	...
	private CentreTransforVO read() {
		...
		CentreTransforVO vo = new CentreTransforVO(transferStyle, dataOfGetin, centreTransferID,banHao, start,
				arrival, JianZhuangYuan, YaYunYuan,	null, Double.parseDouble(fee), 0);
